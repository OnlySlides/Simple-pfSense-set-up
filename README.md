...
<img src="https://i.imgur.com/JjnG0So.png" height="60%" width="60%" alt="pfSense Steps"/>
<br />
Extract file: <br/>
...
After pfSense installation is complete, iso image needs to be removed from pfSense VM storage settings in order for the system to boot from the virtual disk where it was installed. If the iso image is not removed, pfSense will continue rebooting into its terms and conditions notice. Start the pfSense VM again after.
<p align="center">
...
<img src="https://i.imgur.com/ZQIwuSo.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Result after removing iso image: <br/>
<img src="https://i.imgur.com/3tgflBz.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Start pfSense VM > No if VLANs should be set up now > input correct WAN & LAN interfaces > confirm choices: <br/>
<img src="https://i.imgur.com/8sEkf1L.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />

In a real-life environment, the default WAN IP address will likely be our public IP address. Assigning the same NAT network to another VM should result in being in the same network as the pfSense machine (in theory). Confirm the IP addresses in the Windows VM by using command prompt. We want to see the Windows VM default gateway IP address to match the pfSense LAN IP address. 
<p align="center">
...
<img src="https://i.imgur.com/yzFbG7o.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
LAN IP address in pfSense shell matches Windows VM default gateway IP: <br/>
<img src="https://i.imgur.com/HEOoNxL.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
<br />
...
<img src="https://i.imgur.com/ewWbhLB.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Now able to access the pfSense web interface: <br/>
<img src="https://i.imgur.com/eP9FQ81.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
<br />

Default credentials are "admin" & "pfsense". After signing in, a set-up wizard will occur. For the purposes of this project, majority of the configurations will be left default except RFC1918 Networks configuration. <br /> 
...
<img src="https://i.imgur.com/GsMBnW9.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
In step 4 of the set-up wizard - uncheck "Block RFC1918 Private Networks": <br/>
<img src="https://i.imgur.com/RLhinEw.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
In step 5 of the set-up wizard - leave default (should be the gateway address): <br/>
<img src="https://i.imgur.com/9BBhzrO.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
In step 6 of the set-up wizard - set a different admin password: <br/>
<img src="https://i.imgur.com/84dUkdh.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Reload configuration & Finish: <br/>
<img src="https://i.imgur.com/bvRtTS7.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
<img src="https://i.imgur.com/JdBEFiW.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
<br />
...
<img src="https://i.imgur.com/bS6yaYg.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Firewall rules page: <br/>
<img src="https://i.imgur.com/qlSfpeY.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
<br />

After basic set-up of pfSense, my goal is to create a few simple rules so pings from the Windows VM to the default gateway (pfSense shell LAN IP address) succeeds or fails. <br />
Rule #1 function: blocks any traffic from any source to the destination IP address of 192.168.1.1. When the rule is enabled, we should see pings fail. When the rule is disabled, we should see pings succeed. <br />
Rule #2 function: similar rule as rule #1 but instead allows any traffic from any source to the destination IP address of 192.168.1.1. 
<p align="center">
Pings to 192.168.1.1 from Windows VM succeed initially: <br/>
<img src="https://i.imgur.com/57rW1Xc.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Firewall > Rules > LAN > either direction green Add button > rule set-up > Save: <br/>
<img src="https://i.imgur.com/I780ueD.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
<p align="center">
After changes has been applied: <br/>
<img src="https://i.imgur.com/5fIzDah.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Pings to 192.168.1.1 from Windows VM now fail with pfSense Wins block enabled: <br/>
<img src="https://i.imgur.com/YggSc8F.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Disable the rule to verify pings succeed again: <br/>
<img src="https://i.imgur.com/YUPStWb.png" height="40%" width="40%" alt="pfSense Steps"/>
<br />
...
<img src="https://i.imgur.com/2vuXk4A.png" height="40%" width="40%" alt="pfSense Steps"/>
<br />
<br />

Create rule #2 but Action Pass instead of Block with all other details the same > Apply changes. Rules are ordered from top-to-bottom so rules at the top overrule those below them. <br/>
...
<p align="center">
Rule Action - Pass: <br/>
<img src="https://i.imgur.com/Wh83zrg.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Two different rules: <br/>
<img src="https://i.imgur.com/wjstI6y.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Successful pings: <br/>
<img src="https://i.imgur.com/u3uACgJ.png" height="40%" width="40%" alt="pfSense Steps"/>
<br />
Moving the allow rule below the block rule: <br/>
<img src="https://i.imgur.com/9zXzmUs.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
Pings failing: <br/>
<img src="https://i.imgur.com/cHWkJ4y.png" height="30%" width="30%" alt="pfSense Steps"/>
<br />
